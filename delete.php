    ...
    <div class="add-event-wrapper  ">
        ...
        <div class="add-event-body">
            ...
            <div class="add-event-footer">
                <input type="submit" id="add-event" name="delete" value="DELETE"class="add-event-btn"></button>
...
if(isset($_POST['delete'])){
    ...
    // $stml  =$cn ->prepare("DELETE FROM events  WHERE day =? , month= ?,year=?,title=?,location=?,time=?");
    $stml  =$cn ->prepare("DELETE FROM events  WHERE  day = ? AND month = ? AND year = ? AND title=?");
    $stml -> bind_param("iiis", $day,$month,$year,$title);
    // day = ?AND  month=? AND year =? AND
    // $stml -> bind_param("iiisss", $day, $month,$year,$title,$location,$time);
